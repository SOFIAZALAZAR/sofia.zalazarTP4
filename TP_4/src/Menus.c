...
int menu()
{
    ...
    printf("10. Mostrar Listado de empleados dados de baja\n");
    printf("11. Volver a dar de alta un empleado dado de baja\n");
    printf("12. Guardar una copia de los empleados dados de baja .csv\n");
    printf("13. Salir\n");
